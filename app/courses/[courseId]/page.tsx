  ...
  const [lessons, setLessons] = useState<Lesson[]>([
    {
      ...
      order_index: 1,
      drive_video_id: '1aBcDeFgHiJkLmNoPqRsTuVwXyZ',
      pdf_file_id: 'sample-pdf-id',
      is_completed: true,
    },
    {
      id: 'les-02',
                ...
                {activeLesson.pdf_file_id && (
                  <div className="pt-2">
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="inline-block px-4 py-2 bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-semibold rounded-xl"
                    >
